...
- (IBAction)deleteFile:(id)sender {
    UIAlertView * deletionAlertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Delete video", @"delete video alert")
                                                                 message:[NSString stringWithFormat:NSLocalizedString(@"Are you sure you want to delete \"%@\"?", @"delete video alert"), self.file.title]
                                                                delegate:self
                                                       cancelButtonTitle:NSLocalizedString(@"Delete", @"delete video alert")
                                                       otherButtonTitles:NSLocalizedString(@"Cancel", @"delete video alert"), nil];
